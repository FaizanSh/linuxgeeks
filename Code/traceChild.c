...
int traceChildProcess( pid_t tracedPid )
{
    ...
    ptrace(PTRACE_SETOPTIONS,stoppedPid,NULL,PTRACE_O_TRACEFORK | PTRACE_O_TRACEVFORK | PTRACE_O_TRACESYSGOOD); //set options VFORK is jumbbo
